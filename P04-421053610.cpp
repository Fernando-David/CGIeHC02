...
int main()
{
	...
	*/
	...
	glm::mat4 modelcuerpo(1.0);//Inicializar matriz de Modelo 4x4
	glm::mat4 modelabajo(1.0);
	glm::mat4 modelderecha(1.0);
	glm::mat4 modelizquierda(1.0);
	glm::mat4 modelcentro(1.0);
	glm::mat4 modelatras(1.0);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//CREANDO cuerpo principal de la araña
		model = glm::mat4(1.0f);
		...
		color = glm::vec3(0.5765f, 0.5843f, 0.6f);
		...
		//creando oreja derecha
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.1f, 0.5f, 0.0f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.7071f, 0.7071f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.4078f, 0.4196f, 0.4314f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		sp.render();
		...
		//creando oreja izquierda
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.1f, 0.5f, 0.0f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.7071f, -0.7071f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.4078f, 0.4196f, 0.4314f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		sp.render();
		...
		//creando primera seccion pierna derecha
		model = glm::translate(model, glm::vec3(3.5f, 3.5f, 0.0f));
		modelderecha = model;
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(10.0f, 1.5f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5882f, 0.5882f, 0.651f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();

		//Articulacion segunda seccion pierna derecha
		model = modelderecha;
		model = glm::translate(model, glm::vec3(3.5f, 3.5f, 0.0f));
		...
		//creando segunda seccion pierna derecha
		model = glm::translate(model, glm::vec3(0.0f, -7.0f, 0.0f));
		modelderecha = model;
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(15.0f, 1.5f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5882f, 0.5882f, 0.651f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();
		...
		//creando primera seccion pierna izquierda
		model = glm::translate(model, glm::vec3(-3.5f, 3.5f, 0.0f));
		modelizquierda = model;
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, -1.0f));
		model = glm::scale(model, glm::vec3(10.0f, 1.5f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5882f, 0.5882f, 0.651f);
		...
		//Articulacion segunda seccion pierna izquierda	
		model = modelizquierda;
		model = glm::translate(model, glm::vec3(-3.5f, 3.5f, 0.0f));
		...
		//creando segunda seccion pierna izquierda
		model = glm::translate(model, glm::vec3(0.0f, -7.0f, 0.0f));
		modelizquierda = model;
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(15.0f, 1.5f, 1.5f));
		...
		//creando primera seccion pierna trasera
		...
		//Articulacion segunda seccion pierna trasera
		model = modelatras;
		model = glm::translate(model, glm::vec3(0.0f, 3.5f, -3.5f));
		...
		//creando segunda seccion pierna trasera
		model = glm::translate(model, glm::vec3(0.0f, -7.0f, 0.0f));
		modelatras = model;
		...
		//creando primera seccion pierna delantera
		model = glm::translate(model, glm::vec3(0.0f, 3.5f, 3.5f));
		modelcentro = model;
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		//Articulacion segunda seccion pierna delantera
		model = modelcentro;
		model = glm::translate(model, glm::vec3(0.0f, 3.5f, 3.5f));
		model = glm::rotate(model, glm::radians(145.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion10()), glm::vec3(-1.0f, 0.0f, 0.0f));//modificar
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.4078f, 0.4196f, 0.4314f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		sp.render();

		//creando segunda seccion pierna delantera
		model = glm::translate(model, glm::vec3(0.0f, -7.0f, 0.0f));
		modelcentro = model;
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(-1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(-0.7071f, 0.7071f, 0.0f)); //Calculando el seno y coseno de 45 grados, ya que los ejes X y Y se encuentran rotados 135 grados
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		//Piramide cuadrangular base de la grúa
		model = glm::mat4(1.0f);
