...
int main()
{
	...
	DaCapo_M = Model();
	DaCapo_M.LoadModel("Models/DaCapoLampara.fbx");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Helicóptero
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 5.0f, 8.0));
		model = glm::translate(model, glm::vec3(0.0f + mainWindow.getmuevex(), 0.0f, 0.0f));
		LuzPosition = glm::vec3(0.0f + mainWindow.getmuevex(), 5.0f, 8.0f);
		spotLights[3].SetFlash(LuzPosition, glm::vec3(0.0f, -1.0f, 0.0f));
		...
		//Luz del coche
		/*
		LuzPosition = glm::vec3(-25.0f + mainWindow.getmuevex(), 3.5f, 3.0f);
		spotLights[2].SetFlash(LuzPosition, glm::vec3(1.0f,0.0f,0.0f));
		*/
		//--------
		...
		//Lamaparas Da Capo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(10.0f, 4.7f, -10.0f));
