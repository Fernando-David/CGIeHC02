...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_F)
	{
		...
		if (theWindow->articulacion1 < 45.0f) // límite superior
	...
	if (key == GLFW_KEY_H)
	{
		...
		if (theWindow->articulacion3 < 45.0f) // límite superior
	...
	if (key == GLFW_KEY_K)
	{
		...
		if (theWindow->articulacion5 < 45.0f) // límite superior
	...
	if (key == GLFW_KEY_Z)
	{
		...
		if (theWindow->articulacion7 < 45.0f) // límite superior
	...
	if (key == GLFW_KEY_C)
	{
		...
		if (theWindow->articulacion9 < 45.0f) // límite superior
			theWindow->articulacion9 += 5.0f;
	}

	if (key == GLFW_KEY_V)
	{
		//theWindow->articulacion += 10.0;
